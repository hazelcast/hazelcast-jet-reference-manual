...
----
include::{sourceDir}/ImplementAggregation.java[tag=s1]
----
...
Let us now study a use case that calls for co-aggregation. We are
...
[source,java,indent=0]
----
include::{sourceDir}/ImplementAggregation.java[tag=s2]
----
