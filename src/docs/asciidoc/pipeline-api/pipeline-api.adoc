...
- {jet-javadoc}/pipeline/StreamSourceStage.html#withDefaultTimestamps--[`withDefaultTimestamps()`]:
...
- {jet-javadoc}/pipeline/StreamSourceStage.html#withTimestamps-com.hazelcast.jet.function.DistributedToLongFunction-long-[`withTimestamps()`]:
...
also <<caveats-of-not-adding-timestamps-in-the-source>>.
