...
Hazelcast Jet jobs to your cluster, see the {jet-samples}/integration/kubernetes[Kubernetes Integration] 
code sample
...
With the <<automatic-elasticity, Automatic Elasticity>>
...
snapshotting and processing guarantees see <<fault-tolerance, Fault Tolerance>>
section.
