...
[source]
----
include::{javasource}/ExpertZone.java[tag=bp1]
----
...
[source]
----
include::{javasource}/ExpertZone.java[tag=bp2]
----
...
[source]
----
include::{javasource}/ExpertZone.java[tag=bp3]
----
...
[source]
----
include::{javasource}/ExpertZone.java[tag=bp4]
----
