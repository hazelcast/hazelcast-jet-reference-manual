...
[source]
----
include::{javasource}/ExpertZoneBestPractices.java[tag=s1]
----
...
[source]
----
include::{javasource}/ExpertZoneBestPractices.java[tag=s2]
----
...
[source]
----
include::{javasource}/ExpertZoneBestPractices.java[tag=s3]
----
...
[source]
----
include::{javasource}/ExpertZoneBestPractices.java[tag=s4]
----
