...
[source]
----
include::{sourceDir}/ExpertZone.java[tag=bp1]
----
...
[source]
----
include::{sourceDir}/ExpertZone.java[tag=bp2]
----
...
[source]
----
include::{sourceDir}/ExpertZone.java[tag=bp3]
----
...
[source]
----
include::{sourceDir}/ExpertZone.java[tag=bp4]
----
