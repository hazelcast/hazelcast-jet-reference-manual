...
[source]
----
include::{javasource}/ExpertZoneDag.java[tag=s0]
----
...
[source]
----
include::{javasource}/ExpertZoneDag.java[tag=s1]
----
...
[source]
----
include::{javasource}/ExpertZoneDag.java[tag=s2]
----
...
[source]
----
include::{javasource}/ExpertZoneDag.java[tag=s3]
----
...
employing local edges. They are implemented with the most efficient kind
of concurrent queue: single-producer, single-consumer array-backed
queue. It employs wait-free algorithms on both sides and avoids even the
latency of `volatile` writes by using `lazySet`.
...
[source]
----
include::{javasource}/ExpertZoneDag.java[tag=s4]
----
...
[source]
----
include::{javasource}/ExpertZoneDag.java[tag=s5]
----
...
upstream source processors. Activate this policy by calling `isolated()`
on the edge:

[source]
----
include::{javasource}/ExpertZoneDag.java[tag=s6]
----
...
[source]
----
include::{javasource}/ExpertZoneDag.java[tag=s7]
----
...
[source]
----
include::{javasource}/ExpertZoneDag.java[tag=s8]
----
...
[source]
----
include::{javasource}/ExpertZoneDag.java[tag=s9]
----
...
[source]
----
include::{javasource}/ExpertZoneDag.java[tag=s10]
----
...
high-priority edges have been fully consumed.
...
[source]
----
include::{javasource}/ExpertZoneDag.java[tag=s11]
----
