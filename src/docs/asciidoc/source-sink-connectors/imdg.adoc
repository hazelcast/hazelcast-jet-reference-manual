...
[source]
----
include::{javasource}/ImdgConnectors.java[tag=s1]
----

[source]
----
include::{javasource}/ImdgConnectors.java[tag=s2]
----
...
[source]
----
include::{javasource}/ImdgConnectors.java[tag=s7]
----
...
[source]
----
include::{javasource}/ImdgConnectors.java[tag=s8]
----
...
or
{hz-javadoc}/com/hazelcast/query/PredicateBuilder.html[`PredicateBuilder`],
...
[source]
----
include::{javasource}/ImdgConnectors.java[tag=s9]
----
...
[source]
----
include::{javasource}/ImdgConnectors.java[tag=s10]
----
...
[source]
----
include::{javasource}/ImdgConnectors.java[tag=s11]
----
...
[source]
----
include::{javasource}/ImdgConnectors.java[tag=s12]
----
...
[source]
----
include::{javasource}/ImdgConnectors.java[tag=s13]
----
...
[source]
----
include::{javasource}/ImdgConnectors.java[tag=s3]
----
+
...
[source]
----
include::{javasource}/ImdgConnectors.java[tag=s4]
----
+
NOTE: This operation is **NOT** lock-aware, it will process the entries
regardless whethere they are locked or not. We significancly boost
...
[source]
----
include::{javasource}/ImdgConnectors.java[tag=s5]
include::{javasource}/ImdgConnectors.java[tag=s6]
----
...
[source]
----
include::{javasource}/ImdgConnectors.java[tag=s14]
----
...
[source]
----
include::{javasource}/ImdgConnectors.java[tag=s15]
----
