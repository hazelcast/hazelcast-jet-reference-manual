...
|<<jdbc>>
|{jet-javadoc}/pipeline/Sources.html#jdbc-com.hazelcast.jet.function.DistributedSupplier-com.hazelcast.jet.function.ToResultSetFunction-com.hazelcast.jet.function.DistributedFunction-[Source]
