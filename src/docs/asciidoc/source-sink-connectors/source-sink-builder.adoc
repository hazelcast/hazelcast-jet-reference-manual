...
of {jet-javadoc}/core/WatermarkSourceUtil[`WatermarkSourceUtil`].
...
with the _at-least_once_ or _exactly-once_ processing guarantee.
...
[source]
----
include::{javasource}/SourceSinkBuilders.java[tag=s4]
----
...
[source]
----
include::{javasource}/SourceSinkBuilders.java[tag=s5]
----
