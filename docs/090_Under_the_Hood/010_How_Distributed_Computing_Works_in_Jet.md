...
describe it in the [Jet Pipeline API](https://github.com/hazelcast//hazelcast-jet-code-samples/blob/0.5-maintenance/batch/wordcount/src/main/java/WordCount.java):
